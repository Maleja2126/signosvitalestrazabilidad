...
import { FaClipboardCheck, FaUserPlus, FaUserNurse } from "react-icons/fa6"; // Nuevo ícono de enfermero/a
...
const AdminPanel = () => {
    ...
    style={{ width: '80%' }} // Ajuste de ancho
>
    <FaClipboardCheck className="inline-block text-blue-600 text-4xl mb-4" /> {/* Ícono de historial */}
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full max-w-4xl">
        ...
        {/* Botón de trazabilidad (cambié el ícono para que no se repita) */}
        <motion.div
            className="flex flex-col items-center bg-white p-8 rounded-lg shadow-lg hover:shadow-2xl transition transform hover:scale-105"
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
            <motion.div
                ...
                transition={{ repeat: Infinity, duration: 1.5 }}
            >
                <FaUsersGear className="w-20 h-20 text-purple-500 mb-6 transition-transform transform hover:scale-110" /> {/* Cambié el ícono aquí */}
            </motion.div>
